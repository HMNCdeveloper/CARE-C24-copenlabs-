...
namespace MahAppsExample
{
    public class Database
    {
        ...
        public object RegistrarPacienteD(string nombre, string apellido1, string apellido2, string email, string sexo, string profesion, string titulo, string fechanac, string fpg)
        {
            ...
            string sql = "INSERT INTO rad_pacientes(nombre,apellido1,apellido2,email,sexo,profesion,titulo,fechanacimiento,fpg) VALUES($$" + nombre + "$$,$$" + apellido1 + "$$,$$" + apellido2 + "$$,$$" + email + "$$,$$" + sexo + "$$,$$" + profesion + "$$,$$" + titulo + "$$,$$" + fechanac + "$$,$$" + fpg + "$$)";
        ...
        {
            string sql = "SELECT idp from rad_pacientes where nombre=$$" + nombre + "$$ and apellido1=$$" + apellidopat + "$$ and apellido2=$$" + apellidomat + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
        ...
        {
            string sql = "SELECT idtel from rad_telefonos where numero=$$" + telefono + "$$ and extension=$$" + extension + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string sql = "SELECT ida from rad_antecedentes where titulo=$$" + titulo + "$$ and texto=$$" + descripcion + "$$ and tipo=$$" + tipo + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string sql = "SELECT * FROM ObtenerAnalisisPorPaciente($$" + paciente_nombre + "$$)";
            Console.WriteLine(sql);
        ...
        {
            string sql = "SELECT * FROM(SELECT rad_analisis.nombre, rad_analisis.fecha, CONCAT(rad_pacientes.nombre, ' ', rad_pacientes.apellido1, ' ', rad_pacientes.apellido2) as nombrepaciente from rad_analisis INNER JOIN rad_pacientes ON(rad_analisis.paciente = rad_pacientes.idp)) as tabla where UPPER(nombre) like '%" + nombre_analisis + "%' and nombrepaciente = $$" + paciente_nombre + "$$";
            NpgsqlDataAdapter da2 = new NpgsqlDataAdapter(sql, conn);
            ds2.Reset();
            da2.Fill(ds2);
            dt2 = ds2.Tables[0];
        ...
        public object Obtener_IdDomicilio_Paciente(string calle, string numero, string colonia, string CP, string municipio, string estado, string pais, string id_paciente)
        {
            ...
            string sql = "SELECT iddom from rad_domicilios where calle=$$" + calle + "$$ and numero=$$" + numero + "$$ and colonia=$$" + colonia + "$$ and cp=$$" + CP + "$$ and municipio=$$" + municipio + "$$ and estado=$$" + estado + "$$ and pais=$$" + pais + "$$ and idpaciente=$$" + id_paciente + "$$";
            Console.WriteLine(sql);
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string sql = "SELECT count(*) from rad_pacientes where nombre=$$" + nombre + "$$ and apellido1=$$" + apellidopat + "$$ and apellido2=$$" + apellidomat + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string sql = "SELECT count(*) from rad_analisis WHERE idpaciente=$$" + paciente + "$$ and nombre=$$" + nombre_analisis + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string sql = "SELECT count(*) from rad_codigosdeanalisis WHERE analisis=$$" + id_analisis + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string  sql = "select id from rad_analisis where nombre=$$" + nombre + "$$";
            Console.WriteLine(sql);
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
        ...
        {
            string sql = "select * from ObtenerCodigosdeAnalsis($$" + id_analisis + "$$,$$" + Database.table + "$$)";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
            return dt3; //regresa tabla con datos del paciente
        }
        ...
        public DataTable Buscar_Paciente(string paciente)
        {
            ...
            string  sql = "SELECT idp,fpg, CONCAT(nombre,' ', apellido1, ' ', apellido2) as nombrepaciente FROM rad_pacientes WHERE UPPER(CONCAT(nombre, ' ', apellido1, ' ', apellido2)) LIKE '%" + paciente + "%'ORDER BY nombre";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
        ...
        {
            string sql = "SELECT * from rad_pacientes WHERE idp=$$" + paciente + "$$";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
        ...
        {
            string  sql = "select nombre,apellido1,apellido2 from rad_pacientes order by nombre";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "select concat(nombre,' ',apellido1,' ',apellido2) as nombre from rad_pacientes where UPPER(nombre) like $$%" + nombre_paciente + "%$$";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
        ...
        {
            string  sql = "SELECT numero,extension from rad_telefonos WHERE idobj=$$" + paciente + "$$";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
        ...
        {
            string  sql = "SELECT calle,numero,colonia,cp,municipio,estado,pais,idpaciente FROM rad_domicilios WHERE idpaciente=$$" + paciente + "$$ ORDER BY calle";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
        ...
        {
            string  sql = "SELECT idpaciente,ida,nombre,fecha from rad_analisis WHERE idpaciente=$$" + paciente + "$$ and nombre=$$" + nombre_analisis + "$$";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
        ...
        {
            string  sql = "SELECT nombrecodigo,nivel,valor,nivelsugerido,ida from rad_codigosdeanalisis WHERE ida=$$" + id_analisis + "$$";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
        ...
        {
            string sql = "SELECT paciente,id,nombre,fecha from rad_analisis WHERE paciente=$$" + paciente + "$$";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
        ...
        {
            string sql = "SELECT titulo,texto,tipo from rad_antecedentes WHERE idpaciente=$$" + paciente + "$$";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
        ...
        public DataTable Listado_Pacientes()
        {
            ...
            string  sql = "SELECT idp,fpg, CONCAT(nombre,' ', apellido1, ' ', apellido2) as nombrepaciente from rad_pacientes order by nombre";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            dataSet.Reset();
            da.Fill(dataSet);
            daTable = dataSet.Tables[0];
            return daTable; //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string  sql = "INSERT INTO rad_analisis(idpaciente,nombre,fecha,tipoanalisis,fechac) VALUES($$" + id_paciente + "$$,$$" + nombre + "$$,$$" + fecha + "$$,$$" + tipoanalisis + "$$,$$" + fecha + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
        ...
        {
            string  sql = "UPDATE rad_tratamientosadistancia SET tiempoemitido=@tiempoemitido WHERE idt=@idTratamiento";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
        ...
        {
            string  sql = "Select idp from(SELECT idp, fpg, CONCAT(nombre, ' ', apellido1, ' ', apellido2) as nombrepaciente from rad_pacientes) as Tabla where nombrepaciente like $$%" + nombre + "%$$";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
        ...
        {
            string  sql = "select * from rad_tratamientosadistancia where estado=1 and duracion != tiempoemitido  ORDER BY fechainicio DESC";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds.Reset();
            da.Fill(ds);
        ...
        {
            string  sql = "DELETE FROM rad_codigosdetratamientos USING rad_tratamientosadistancia WHERE rad_codigosdetratamientos.idcr = CAST(rad_tratamientosadistancia.idt AS text)  AND ((rad_tratamientosadistancia.duracion = rad_tratamientosadistancia.tiempoemitido   AND rad_tratamientosadistancia.estado = 1 ) OR (rad_tratamientosadistancia.fechac < NOW() AND rad_tratamientosadistancia.estado=0) ) AND (SELECT COUNT(*) FROM rad_tratamientosadistancia t WHERE t.idt=rad_tratamientosadistancia.idt)=1;";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();

            command.CommandText = "DELETE FROM rad_tratamientosadistancia WHERE (tiempoemitido=duracion and estado=1)  OR (fechac < NOW() AND estado=0);";
            command.ExecuteNonQuery();
        }
        ...
        {
            string  sql = "select count(*) from rad_tratamientosadistancia where estado=0";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string sql = "select nombre,fechainicio from rad_tratamientosadistancia where estado=0";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds.Reset();
            da.Fill(ds);
        ...
        {
            string  sql = "select * from rad_tratamientosadistancia where idpadre=$$" + id_tratamiento + "$$";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds.Reset();
            da.Fill(ds);
        ...
        {
            string  sql = "delete from rad_tratamientosadistancia where estado=0 and (nombre=$$" + nombreTratamiento + "$$ and inicio=$$" + Fecha + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "delete from rad_tratamientosadistancia where estado=1 and nombre=$$" + nombreTratamientoP + "$$ and idpadre=''";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
        ...
        {
            string  sql = "delete from rad_tratamientosadistancia where estado=0 and nombre=$$" + nombreTratamientoP + "$$ and idpadre<>''";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            int i = command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "delete from rad_tratamientosadistancia where idt =$$" + idTratamiento + "$$  ";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            int i = command.ExecuteNonQuery();
        }
        ...
        {
            string  sql = "SELECT count(*) FROM rad_tratamientosadistancia where nombre=$$" + nombreTratamiento + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string  sql = "INSERT INTO rad_analisis(paciente, nombre, fecha, analisado, reanalizado) VALUES(@paciente, @nombre, @fecha,  @analizado, @reanalizar)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
        ...
        public void Actualizar_Fecha_Analisis(string fecha,string id_analisis)
        {
            string sql = "UPDATE rad_analisis SET fecha=$$"+fecha+"$$  WHERE id=$$"+id_analisis+"$$";
            Console.WriteLine(sql);
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string   sql = "SELECT fecha FROM  rad_analisis WHERE id=$$"+id_analisis+"$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        {
            string  sql = "INSERT INTO rad_rversion(nombre,descripcion) VALUES($$" + nombre + "$$,$$" + descripcion + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "INSERT INTO rad_domicilios(calle,numero,colonia,cp,municipio,estado,pais,idpaciente) VALUES($$" + calle + "$$,$$" + numero + "$$,$$" + colonia + "$$,$$" + cp + "$$,$$" + municipio + "$$,$$" + estado + "$$,$$" + pais + "$$,$$" + id_paciente + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string  sql = "INSERT INTO rad_antecedentes(titulo,texto,idpaciente,tipo) VALUES($$" + titulo + "$$,$$" + texto + "$$,$$" + id_paciente + "$$,$$" + tipo + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string  sql = "INSERT INTO rad_telefonos(numero,extension,idobj) VALUES($$" + telefono + "$$,$$" + extension + "$$,$$" + id_paciente + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string  sql = "SELECT * FROM rad_remedios where nombre=$$" + nombre_remedio + "$$";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string  sql = "SELECT * FROM rad_rversion";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string  sql = "select nombre,apellido1,apellido2,email,sexo,fechanacimiento,fpg from rad_pacientes";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "SELECT count(*) FROM rad_remedios where nombre=$$" + nombre_del_duplicado + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string sql = "INSERT INTO rad_remedios(nombre,fecha,idioma) values(@nombre,@fecha,@idioma)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
        ...
        {
             string  sql = "INSERT INTO rad_tratamientosadistancia(idpadre, idpaciente, nombrepaciente, nombre, duracion, tiempoemitido, fechainicio, fechac, estado) VALUES(@id_padre, @idpaciente, @nombrepaciente, @nombre, @duracion, @tiempoemitido, @fechainic, @fechac, @estado)";
        ...
        {
            string sql = "INSERT INTO rad_codigosdetratamientos(idcr,descripcion,tipo) VALUES($$" + idt + "$$,$$" + descripcion + "$$,$$" + tipo + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "SELECT idt FROM rad_tratamientosadistancia where idpaciente=$$" + id_paciente + "$$ and nombrepaciente=$$" + nombre_paciente + "$$ and nombre=$$" + nombre_tratamiento + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        public object Obtener_IDPadre(string id_paciente, string nombre_paciente, string nombre_tratamiento)
        {
            string sql = "SELECT idpadre FROM rad_tratamientosadistancia where idpaciente=$$" + id_paciente + "$$ and nombrepaciente=$$" + nombre_paciente + "$$ and nombre=$$" + nombre_tratamiento + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string  sql = "select * from rad_codigosdetratamientos where idcr=$$" + idt + "$$";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "SELECT count(*) FROM rad_tratamientosadistancia where nombre like $$%" + nombre_tratamiento + "%$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string sql = "SELECT ID FROM rad_codigo WHERE  frecuencia=$$" + frecuencia + "$$ AND SubcategoriaID=$$" + subcategoria + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        {
            string sql = "DELETE FROM rad_codigo WHERE  id=$$" + id + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "DELETE FROM rad_codigosdetratamientos WHERE descripcion=$$" + nameCode+"$$ AND idcr=$$"+idpadre+"$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string  sql = "DELETE FROM rad_codigoCustom WHERE  codigoid=$$" + id + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "INSERT INTO rad_codigos(idcodigo,nombre,codigo,idcat,genero) VALUES($$" + id_generado + "$$,$$" + nombre_tarjeta + "$$,$$" + codigo_generado + "$$,$$" + "-tarjetas-" + "$$,$$" + "0" + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "DELETE FROM rad_telefonos WHERE idobj=$$" + id_paciente + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        ...
        {
            string sql = "UPDATE rad_tratamientosadistancia SET fechainicio=@fecha WHERE idt=@IDs";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
        ...
        {
            string sql = "UPDATE rad_tratamientosadistancia SET estado=1 WHERE idt=$$" + IDs + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        public void ModificarEstadoTratamientoVencido(string IDs)
        {
            string  sql = "UPDATE rad_tratamientosadistancia SET estado=2 WHERE idt=$$" + IDs + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "UPDATE rad_analisis SET analisado = '1' WHERE id = $$" + id_analisis + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "SELECT COUNT(*) FROM rad_codigosdeanalisis WHERE  analisis=$$" + id_analisis + "$$ AND rate=$$"+rate+"$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
        ...
        {
            string sql = "DELETE FROM rad_domicilios WHERE iddom=$$" + id_dom + "$$";
            // sql = "UPDATE rad_pacientes SET nombre='" + nombre + "',apellido1='" + apellido1 + "',apellido2='" + apellido2 + "',email='" + email + "',sexo='" + sexo + "',profesion='" + profesion + "',titulo='" + titulo + "',fechanacimiento='" + fechanac + "',fpg='" + fpg + "' WHERE idp='" + id_paciente + "'";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        public void EliminarTelefonosPacientePorID(string id_telefono)
        {
            ...
            string  sql = "DELETE FROM rad_telefonos WHERE idtel=$$" + id_telefono + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        public void EliminarAnalisisPorNombre(string nombre_analisis)
        {
            ...
            //INSERT INTO rad_telefonos(numero,extension,idobj) VALUES('
            string sql = "DELETE FROM rad_analisis WHERE nombre=$$" + nombre_analisis + "$$";
            command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            //INSERT INTO rad_telefonos(numero,extension,idobj) VALUES('
            string sql = "DELETE FROM rad_antecedentes WHERE ida=$$" + id_antecedente + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            //INSERT INTO rad_telefonos(numero,extension,idobj) VALUES('
            string sql = "DELETE FROM rad_antecedentes WHERE titulo=$$" + titulo + "$$ and texto=$$" + descripcion + "$$ and tipo=$$" + tipo + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            //INSERT INTO rad_telefonos(numero,extension,idobj) VALUES('
            string sql = "DELETE FROM rad_remedios WHERE nombre=$$" + nombre + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        ...
        public void Eliminar_remedio_codigo(int id)
        {
            ...
            string sql = "DELETE FROM rad_codigosdeterapia WHERE  id  IN ( select terapiacolor from rad_codigosderemedios WHERE remedio=$$" + id + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        ...
        {
            string sql = "SELECT * FROM rad_categoria" + Database.table + "  order by Nombre ASC";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "SELECT * FROM rad_categoriacustom order by Nombre ASC";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "SELECT ID FROM rad_categoria" + Database.table + " where Nombre=$$" + nombre_categoria + "$$ ";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        {
            string sql = "SELECT ID FROM rad_categoriacustom  where Nombre=$$" + nombre_categoria + "$$ ";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        {
            string sql = "SELECT subcategoriaid  FROM rad_Subcategoria" + Database.table + " where Nombre= $$" + nameSub + "$$ AND  subcategoriaid IN (SELECT id FROM rad_subcategoria WHERE CategoriaID=$$" + categorieID + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        {
            string sql = "SELECT  subcategoriaid FROM rad_SubcategoriaCustom where Nombre= $$" + nameSub + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        {
            string sql = "SELECT Nombre FROM rad_Subcategoria" + Database.table + " Where SubcategoriaID IN  (Select ID FROM rad_SubCategoria Where CategoriaID='" + categoria + "') ORDER BY Nombre";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "SELECT Nombre FROM rad_Subcategoriacustom Where SubcategoriaID IN  (Select ID FROM rad_SubCategoria Where CategoriaID='" + categoria + "') ORDER BY Nombre";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "SELECT * FROM  ObtenerCodigo" + Database.table + "($$" + idSubcategorie + "$$)";   
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "SELECT * FROM  ObtenerCodigoPerzonalizada($$" + idSubcategorie + "$$)";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        public DataTable VisualizarSubCategoriasCodigosListado(string categoria, string genero_paciente)
        {
            ...
            string sql = "SELECT * FROM rad_codigos where idcat=$$" + categoria + "$$ and (genero=$$" + genero_paciente + "$$ or genero='P') order by nombre";
        ...
        {
            string sql = "SELECT rate FROM rad_codigo where UPPER(nombre)=$$" + nombre_categoria + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        {
            string sql = "SELECT * FROM BuscarIndice($$" + nombre_codigo + "$$,$$" + Database.table + "$$)";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        public DataTable BuscarCodigoRem(string nombre_codigo)
        {
            ...
            string sql = "SELECT nombre,id FROM rad_remedios WHERE UPPER(nombre) LIKE $$%" + nombre_codigo + "%$$ AND  lenguaje in ('CUS','"+leng+"')";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string  sql = "SELECT nombre FROM rad_codigos WHERE nombre LIKE $$" + nombre_codigo + "$$";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string  sql = "SELECT analisado from rad_analisis where nombre =$$" + nombre_analisis + "$$";
        ...
        {
            string sql = "SELECT reanalizado from rad_analisis where nombre =$$" + nombre_analisis + "$$";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "SELECT codigoid  from rad_codigo" + Database.table + " where id=$$" + codigoid + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string sql = "SELECT id from rad_analisis where nombre=$$" + nombre_analisis + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string sql = "INSERT INTO rad_categoriaCustom(ID,Nombre) VALUES($$" + CategoriaID + "$$,$$" + nombre + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        public void Registrar_Codigo(Guid id, string frecuencia, Guid subCategoria)
        {
            string sql = "INSERT INTO rad_codigo(id,frecuencia,SubcategoriaID) VALUES($$" + id + "$$,$$" + frecuencia + "$$,$$" + subCategoria + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        public void Registrar_CodigoPersonalizado( string nombre, Guid codigo)
        {
            string sql = "INSERT INTO rad_codigoCustom(nombre,CodigoID) VALUES($$" + nombre + "$$,$$" + codigo + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        ...
        {
            string sql = "SELECT frecuencia FROM rad_codigo where frecuencia=$$"+frecuencia+"$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);    
        ...
        {
            string sql = "INSERT INTO rad_Subcategoriacustom(nombre,SubcategoriaID) VALUES($$" + nombre + "$$,$$" + SubcategoriaID + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "INSERT INTO rad_Subcategoria(id,CategoriaID) VALUES($$" + id + "$$,$$" + CategoriaID + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        public void Actualizar_Estado(string idTratamiento)
        {
            ...
            string sql = "UPDATE rad_tratamientosadistancia SET estado=1 WHERE idt=$$" + idTratamiento + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            //UPDATE rad_tratamientosadistancia SET tiempoemitido='25' WHERE nombrepaciente='Raul Lopez ' and nombre='prueba completa' and duracion='7200'
            string sql = "DELETE FROM rad_tratamientosadistancia where CAST(EXTRACT(DAY FROM fechainicio)as INT) < CAST(EXTRACT(DAY FROM NOW()) as INT)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "SELECT * FROM rad_tratamientosadistancia WHERE estado = 0 AND fechainicio >= NOW() ORDER BY fechainicio ASC  LIMIT 30";
            //command = new NpgsqlCommand(sql, conn);
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds.Reset();
            da.Fill(ds);
        ...
        {
            string sql = "select categoriaID from rad_categoria" + Database.table + " where Nombre=$$" + nombre + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        {
            string sql = "select ID from rad_subcategoria where CategoriaID=$$" + CategoriaID + "$$";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "SELECT fecha from rad_remedios where nombre=$$" + nombre + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string sql = "INSERT INTO rad_codigosdeanalisis(analisis,rate,valor,nivel,nivelsugerido,potencia,potenciasugerido) VALUES($$" + id_analisis + "$$,$$" + codigo + "$$,$$" + valor + "$$,$$" + nivel + "$$,$$" + nivelsugerido + "$$,$$" + potencia + "$$,$$" + potenciaSugeridad + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "UPDATE rad_codigosdeanalisis SET valor=$$"+valor+"$$, nivel=$$"+nivel+"$$, nivelsugerido=$$"+nivelsugerido+"$$, potencia=$$"+potencia+ "$$, potenciasugerido=$$"+potenciaSugeridad+"$$ WHERE analisis=$$"+id_analisis+"$$ AND rate=$$"+codigo+"$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        public void Registrar_Informacion_Biologica(double[] infobio, string nombre_analisis)
        {
            ...
            string sql = "UPDATE rad_analisis SET estatura=$$" + infobio[0].ToString() + "$$, presionsisto=$$" + infobio[1].ToString() + "$$, imc=$$" + infobio[2].ToString() + "$$, fr=$$" + infobio[3].ToString() + "$$, ta=$$" + infobio[4].ToString() + "$$, peso=$$" + infobio[5].ToString() + "$$, presiondias=$$" + infobio[6].ToString() + "$$, fc=$$" + infobio[7].ToString() + "$$, valorini=$$" + infobio[8].ToString() + "$$ WHERE nombre=$$" + nombre_analisis + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        //{
        //    string sql = "UPDATE rad_analisis SET padecimientoactual=$$" + padecimiento + "$$, intporaparatos=$$" + interrogatorio_por_aparatos + "$$ WHERE nombre=$$" + nombre_analisis + "$$";
        //    NpgsqlCommand command = new NpgsqlCommand(sql, conn);
        //    command.ExecuteNonQuery();
        //}
        ...
        {
            string sql = "select nombre,codigo,ROW_NUMBER () OVER (ORDER BY nombre) from rad_codigos";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "select nombre,fechac from rad_remedios where nombre like $$%Color%$$ order by fechac";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "select * from  rad_remedios where lenguaje IN ($$" + language + "$$,'CUS') Order by nombre";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "select * from rad_remedios where upper(nombre) like $$%" + nombre + "%$$ AND lenguaje in ($$" + language + "$$,'CUS')";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string  sql = "select * from rad_remedios where codigo='' or codigo is null";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string  sql = "select * from rad_remedios where lenguaje='CUS' order by nombre ASC";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string  sql = "SELECT id from rad_remedios where nombre=$$" + nombre + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        public bool isCustomRemedy(string nombre)
        {
            ...
            {
                string sql = "SELECT lenguaje from rad_remedios where nombre=$$" + nombre + "$$";
                NpgsqlCommand command = new NpgsqlCommand(sql, conn);
        ...
        {
            string sql = "SELECT idr from rad_remedios where nombre=$$" + nombre + "$$ and fechac=$$" + fecha + "$$";
            command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar(); //Valor del id_paciente lo regresa como objeto
        }
        ...
        {
            string sql = "select idp from (select idp,concat(nombre,' ',apellido1,' ',apellido2) from rad_pacientes) as tabla where concat like $$" + nombre + "%$$";
            command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        {
            string sql = "SELECT * FROM ObtenerCodigodeRemedios($$" + id_remedio + "$$,$$" + Database.table + "$$)";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "SELECT * FROM ObtenerCodigosdeTerapiaColor($$" + id_remedio + "$$)";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "select codigo,nombrecodigo from rad_codigosderemedios where idr=$$" + id_remedio + "$$";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "select * from rad_codigoderemedios where remedio=$$" + id_remedio + "$$";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "INSERT INTO rad_codigosderemedios(rate,potencia,metodo,nivel,complemento,remedio) VALUES($$" + codigo + "$$,$$" + potencia + "$$,$$" + metodo + "$$,$$" + nivel + "$$,$$" + complemento + "$$,$$" + remedio + "$$)";
            command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "INSERT INTO rad_codigosderemedios(terapiacolor,potencia,metodo,nivel,complemento,remedio) VALUES($$" + codigo + "$$,$$" + potencia + "$$,$$" + metodo + "$$,$$" + nivel + "$$,$$" + complemento + "$$,$$" + remedio + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            string sql = "INSERT INTO rad_codigosderemedios(autosimil,potencia,metodo,nivel,complemento,remedio) VALUES(@codigo,@potencia,@metodo,@nivel,@complemento,@remedio)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
        ...
        {
            string sql = "INSERT INTO rad_remedios(nombre, fecha , lenguaje) VALUES(@nombre, @fecha, @idioma)";
        ...
        {
            string sql = "INSERT INTO rad_codigosdeterapia(id,codigo,nombre) VALUES($$" + id + "$$,$$" + codigo + "$$,$$" + nombre + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        public DataTable BuscarGenero(string nombre)
        {
            ...
            string sql = "SELECT * FROM rad_pacientes WHERE (nombre || ' ' || apellido1 || ' ' || apellido2) = '" + nombre +"'";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sql, conn);
            ds3.Reset();
            da.Fill(ds3);
            dt3 = ds3.Tables[0];
        ...
        {
            string sql = "DELETE FROM rad_Subcategoriacustom Where SubcategoriaID='"+subcategoriaID+"'";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        ...
        {
            //delete custom rates
            string sql = "DELETE FROM rad_codigocustom Where codigoid IN  (select ID from rad_codigo where subcategoriaID='"+subcategoriaID+"')";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        ...
        {
            string sql = "DELETE FROM rad_Subcategoriacustom Where SubcategoriaID IN  (Select ID FROM rad_SubCategoria Where CategoriaID='" +categoriaID + "')";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        ...
        {
            //delete custom rates
            string sql = "DELETE FROM rad_codigocustom Where codigoid IN  (select ID from rad_codigo where subcategoriaID IN(Select ID FROM rad_SubCategoria Where CategoriaID='" + categoriaID + "'))";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        ...
        {
            string sql = "DELETE FROM rad_categoriacustom Where ID='"+ categoriaID+ "'";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        public void Eliminar_codigos_analisis(int id_analisis, string id_codigo)
        {
            ...
            string sql = "DELETE FROM rad_codigosdeanalisis WHERE analisis=$$" + id_analisis + "$$ AND rate=CAST($$" + id_codigo + "$$ AS uuid)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        {
            //Elimina los colores de codigosderemedios
            string sql = "DELETE FROM rad_codigosderemedios WHERE remedio=$$" + id_remedio + "$$ AND autosimil=$$" + id_autosimil + "$$ ";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        ...
        {
            string sql = "select codigo from rad_colordeterapia where upper(texto)=$$" + color + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        {
            string sql = "INSERT INTO rad_codigos(idcodigo,nombre,codigo,descripcion,idcat,idcatp,genero) values($$" + id_codigo + "$$,$$" + nombre + "$$,$$" + codigo + "$$,$$" + description + "$$,$$" + id_subcategoria + "$$,$$" + id_categoria + "$$,$$" + genero + "$$)";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        }
        ...
        public void CancelarTratamientoADistancia(string nombre)
        {
            ...
            string sql = "DELETE FROM rad_codigosdetratamientos USING rad_tratamientosadistancia WHERE rad_codigosdetratamientos.idcr = CAST(rad_tratamientosadistancia.idt AS text)  AND rad_tratamientosadistancia.nombre=$$" + nombre + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            command.ExecuteNonQuery();
        ...
        {
            string sql = "SELECT idcr FROM rad_codigosderemedios WHERE idcr = '" + codigo + "'";
        ...
        {
            string sql = "SELECT idcr FROM rad_codigosderemedios WHERE idcodigo = '" + codigo + "'";
        ...
        public bool ConexionBD(string user, string password)
        {
            ...
            if (conn == null)
            {
                constring = String.Format("Server=localhost;Port=5432;" + "User Id={0};Password={1};Database={2}", user, password, "copenDB");
        ...
        {
           string sql = "SELECT count(*) FROM  rad_subcategoria WHERE  CategoriaID=$$"+id+"$$";
        ...
        {
            string sql = "SELECT count(*) FROM  rad_categoriaCustom WHERE  Nombre=$$" + name+"$$";
            NpgsqlCommand cmd = new NpgsqlCommand(sql, conn);
        ...
        {
            string sql = "SELECT  id FROM rad_codigo where Frecuencia= $$" + frecuencia + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        {
            string  sql = "SELECT  nombre FROM rad_codigo" + Database.table + " where codigoid= $$" + codigo + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        public bool isRegisterRemedyCode(int IDRemedy, string IDRate)
        {
            ...
            {
                string sql = "SELECT count(*) FROM  rad_codigosderemedios WHERE remedio=@remedio and  rate=CAST(@rate AS uuid)";
                NpgsqlCommand cmd = new NpgsqlCommand(sql, conn);
        ...
        public object GetCodeIDCustom(string nombre )
        {
            ...
            string  sql = "SELECT codigoid from rad_codigocustom  where nombre=$$" + nombre + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        {
            string  sql = "SELECT codigoid from rad_codigo" + Database.table + "  where nombre=$$" + nombre + "$$";
            NpgsqlCommand command = new NpgsqlCommand(sql, conn);
            return command.ExecuteScalar();
        }
        ...
        {
            string sql = "update rad_codigosderemedios set metodo=@metodo, potencia=@potencia,complemento=@complemento, nivel=@nivel WHERE id=CAST(@id as integer)";
            NpgsqlCommand cmd = new NpgsqlCommand(sql, conn);
